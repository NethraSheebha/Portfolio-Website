...
// All sections of the website read from the data below.
// ============================================================
...
export const profile = {
  ...
  tagline:
    "Building software at the intersection of intelligence and engineering. Currently pursuing my degree and contributing to open-source projects.",
  location: "Chennai, India",
  resumeUrl: "https://drive.google.com/file/d/1Q82qXGzPuKKxNn2ZLZugbZxrpzN2v-BH/view?usp=sharing",
};
...
export const projects = [
  {
    ...
    description:
      "An enterprise-grade, high-performance Retrieval-Augmented Generation (RAG) chatbot built to parse, index, and query uploaded documents in real-time.",
  ...
  },
  {
    ...
    description:
      "An Intelligent AI-Assisted Voice-to-Voice Communication Bridge for the Karnataka 1092 Citizen Helpline that is designed to facilitate seamless communication between citizens and government officials, ensuring that dialect and language barriers do not hinder access to essential services.",
...
export const achievements = [
  {
    ...
    date: "Jan 2025",
    description:
      "Top 15 globally for ChemGuardian, an AI-powered chemical leak detection system using multi-agent intelligence and vector similarity search.",
  },
  {
...
export const experience = {
  internship: {
    ...
    points: [
      "Developed a Retrieval-Augmented Generation (RAG) pipeline for natural language\
      database queries in aviation analytics. Enhanced data reliability and interpretability.",
