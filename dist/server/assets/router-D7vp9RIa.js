...
const appCss = "/assets/styles-BiUUxlDj.css";
...
function SiteNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 border-b border-border/60 bg-background/70 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-6xl items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "font-display text-lg font-bold tracking-tight", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "<dev/>" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden gap-1 md:flex", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: l.to,
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "grid gap-1 border-t border-border/60 px-6 py-4 md:hidden", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: l.to,
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border/60 py-8 text-center text-xs text-muted-foreground", children: [
      "Crafted with care · Edit content in ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono text-brand", children: "src/lib/portfolio-data.ts" })
    ] })
  ] }) });
}
const $$splitComponentImporter$7 = () => import("./skills-BkRbL6Zs.js");
const Route$7 = createFileRoute("/skills")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Technical skills across AI/ML, programming, and web."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./projects-Dldk_Xc3.js");
const Route$6 = createFileRoute("/projects")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Selected projects with source code on GitHub."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./experience-DDFObuIj.js");
const Route$5 = createFileRoute("/experience")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Internship experience and open source contributions."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./education-5f_e_HQ_.js");
const Route$4 = createFileRoute("/education")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Academic background: college, 12th, and 10th grade."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-BBAiAgUv.js");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch via email, phone, LinkedIn, or GitHub."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./competitive-C2iiTn3o.js");
const Route$2 = createFileRoute("/competitive")({
  head: () => ({
    meta: [{
      title: "Competitive Programming — Portfolio"
    }, {
      name: "description",
      content: "LeetCode and CodeChef profiles, ratings, and stats."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./achievements-BNnrl0Ak.js");
const Route$1 = createFileRoute("/achievements")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Hackathon wins and notable recognitions."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DLaKcyiE.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of an engineering student — projects, skills, achievements, and experience."
    }]
  }),
...
const CompetitiveRoute = Route$2.update({
  id: "/competitive",
  path: "/competitive",
  getParentRoute: () => Route$8
});
